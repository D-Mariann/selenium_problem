...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Programs\PyCharm\PyCharmProjects\Selenium_test'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Programs\PyCharm\PyCharmProjects\Selenium_test\Scripts\deactivate.nu'
